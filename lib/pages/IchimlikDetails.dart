...
class IchimlikDetails extends StatefulWidget {
  const IchimlikDetails({super.key});

  @override
  State<IchimlikDetails> createState() => _IchimlikDetailsState();
}

class _IchimlikDetailsState extends State<IchimlikDetails> {
