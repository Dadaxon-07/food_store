...
class TaomDetails extends StatefulWidget {
  const TaomDetails({super.key});

  @override
  State<TaomDetails> createState() => _TaomDetailsState();
}

class _TaomDetailsState extends State<TaomDetails> {
  ...
  _apiCreatePost(String ism, String title, String price, String url) {
    ...
    RTDBService.addFood(post).then((value) => {
